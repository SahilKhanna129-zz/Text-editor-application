...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
		    ...
		    BasicDocument file1 = new BasicDocument(checkString);
		    file1.getFleschScore();
		    long endTime = System.nanoTime();
		    double timeTaken = (double)(endTime - startTime)/100000000 ;
		    System.out.print(timeTaken + "\t");
		    
		    startTime = System.nanoTime();
            EfficientDocument file2 = new EfficientDocument(checkString);
            file2.getFleschScore();
            endTime = System.nanoTime();
            timeTaken = (double)(endTime - startTime)/1000000000 ;
            System.out.print(timeTaken + "\n");
